        ...
        <div className='w-full bg-slate-100 py-2 px-5'>
            ...
            <div className='w-full my-4 bg-white px-6 py-3 rounded-xl border border-slate-300 flex flex-col gap-5 justify-start'>
                <div className="flex justify-between items-center">
                    <span ><h3 className='flex gap-2 text-lg font-semibold'>Analysis Complete</h3>
                        <p className='text-slate-500 text-sm flex gap-3'>Role:<p className='text-black font-semibold'>JobTITLE</p></p></span>
                    <span className='flex gap-3 justify-center  items-center'>
                        <div className="rounded-full py-1 px-4 border border-[#05b19a] bg-[#00e9ca]/10 text-xs font-semibold text-[#05b19a] w-fit">7 resume analysed</div>
                        <div className="rounded-full py-1 flex gap-2 items-center px-4 border hover:border-[#05b19a] bg-slate-100 border-slate-300 text-gray-900 text-xs font-semibold hover:text-[#05b19a] w-fit">
                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                            Download CSV
                        </div>
                    </span>
                </div>
                <div className='flex gap-3 mb-2'>
                    <div className='bg-slate-100 pb-2 pt-4 px-5 rounded-xl border border-slate-300 flex flex-col justify-center items-center w-40 flex-1'>
                        <h2 className='text-teal-500 text-2xl font-bold'>78%</h2>
                        <p className='text-slate-500 text-sm Avg Match Score'>Avg Match Score</p>
                    </div>
                    <div className='bg-slate-100 pb-2 pt-4 px-5 rounded-xl border border-slate-300 flex flex-col justify-center items-center w-40 flex-1'>
                        <h2 className='text-teal-500 text-2xl font-bold'>1</h2>
                    ...
                    <div className='bg-slate-100 pb-2 pt-4 px-5 rounded-xl border border-slate-300 flex flex-col justify-center items-center w-40 flex-1'>
                        <h2 className='text-red-500 text-2xl font-bold'>1</h2>
            ...
            <div className="flies">
                <div className="card my-2">
                    <div className="head flex justify-between text-sm px-4 py-4 border border-slate-300/70 rounded-xl bg-white border-b-2 w-full">
                        <div className="flex gap-3 justify-center items-center">
                            <div className='w-8 h-8 text-white font-bold mr-2 rounded-full bg-[#05b19a] text-center p-1.5' >1</div>
                            <div class="shrink-0 w-8 h-8 rounded-xl  p-1 gap-2 bg-slate-100  text-xs font-semibold text-[#05b19a] flex items-center justify-center"><svg class="w-4 h-4 text-accent " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>
                            <div>
                        ...
                        <div className='flex gap-3 justify-center  items-center'>
                            <div className='bg-slate-100 p-1 rounded-xl border border-slate-300 flex flex-col justify-center items-center px-3 '>
                                <h2 className='text-teal-500 text-lg font-bold '>78%</h2>
                                <p className='text-slate-500 text-xs '>match</p>
                            </div>
                            <div className="rounded-full py-1 px-3 border border-[#25cfb9]/40 bg-[#21e7cd]/8 text-xs font-semibold text-[#05b19a] w-fit">Good Match</div>
                            <div className="rounded-lg p-1 justify-center w-7 h-7 flex gap-2 items-center border hover:border-[#05b19a] bg-slate-100 border-slate-300 text-slate-500 text-xs font-semibold hover:text-[#05b19a] ">
                            ...
                            <div className="rounded-lg p-1 justify-center w-7 h-7 flex gap-2 items-center border hover:border-[#05b19a] bg-slate-100 border-slate-300 text-slate-500 text-xs font-semibold hover:text-[#05b19a] ">
                                <svg class="w-4 h-4 transition-transform duration-200 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                            </div>
                        </div>
                    </div>
                </div>
