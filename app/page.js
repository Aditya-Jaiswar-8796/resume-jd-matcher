    ...
    <div className='bg-slate-100 w-full h-full'>
      ...
      <div className="how flex flex-col items-center">
        ...
        <div className="step flex items-start justify-center gap-10 mb-10">
          ...
          <div className="flex flex-col items-center gap-5  mt-10 w-[22vw] relative bg-white p-10 rounded-2xl border border-gray-300 hover:shadow-[0px_0px_10px_4px_#e0e1e1]">
            ...
            <div className="icon flex h-12 w-12 items-center justify-center rounded-lg bg-slate-200/50">
            <svg class="h-7 w-7 text-accent" fill="none" viewBox="0 0 24 24" stroke="teal" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></div>
          ...
          <div className="flex flex-col items-center gap-5  mt-10 w-[22vw] relative bg-white p-10 rounded-2xl border border-gray-300 hover:shadow-[0px_0px_10px_4px_#e0e1e1]">
            ...
            <div className="icon flex h-12 w-12 items-center justify-center rounded-lg bg-slate-200/50">
            <svg class="h-7 w-7 text-accent" fill="none" viewBox="0 0 24 24" stroke="teal" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>
      ...
      <div className="feature flex flex-col items-center">
        ...
        <div className="step flex items-start justify-center gap-10 mb-10">
          ...
          <div className="flex flex-col gap-5  mt-10 w-[25vw] items-left bg-white p-10 rounded-2xl border border-gray-300 hover:shadow-[0px_0px_10px_4px_#e0e1e1]">
            <div className="icon flex h-12 w-12 items-center justify-center rounded-lg bg-slate-200/50">
            <svg class="h-6 w-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="teal" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>
